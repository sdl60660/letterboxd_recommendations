...
def migrate_inactive_ratings(movies_coll, ratings_coll, retired_ratings_coll, filter_exp):
    ...
    movies_coll.aggregate(pipeline, allowDiskUse=True, comment="retire_ratings_by_inactive_movies")
...
def main():
    ...
    print(f"Deleted from live DB/migrated to retired DB - ratings: {deleted_ratings:,}, movies: {deleted_movies:,}")
