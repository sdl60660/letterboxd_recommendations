...
const Result = ({ movie_data, predicted_rating, textColor }) => {
  const imageURL = useMemo(() => {
    ...
    if (url === "") {
      url = "https://s.ltrbxd.com/static/img/empty-poster-230.c6baa486.png";
  ...
  if (
    rawYearReleased === null &&
    movie_data.release_date !== null &&
          ...
          <div className="recommendation-data-wrapper">
            <div className="recommendation-movie-data-wrapper">
              ...
              <div
                ...
                tabIndex="0"
                aria-label={"Displays genres for associated movie"}
              >
