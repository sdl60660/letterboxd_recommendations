...
def create_app(test_config=None):
    ...
    def get_recs():
        ...
        data_opt_in = (request.args.get("data_opt_in") == "on")
        ...
        job_get_user_data = q.enqueue(get_client_user_data, args=(username,data_opt_in,), description=f"Scraping user data for {request.args.get('username')} (sample: {training_data_size}, popularity_filter: {popularity_threshold}, data_opt_in: {data_opt_in})", result_ttl=45, ttl=300)
