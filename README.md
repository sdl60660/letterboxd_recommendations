...
The web crawling/data processing/model building portion of this project (everything that isn't related to what happens on the webpage) lives in the `data_processing` subdirectory. The frontend React app is in the `frontend` subdirectory.
